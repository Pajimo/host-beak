...
const AddBill = ({setAddBill}) => {
    ...
    return(
        <>
            <Header />
            <button className="profile-Show-button bg-[#F9F9F9] w-full" onClick={menuFunction}><AiOutlineMenu /></button>
            <div className="flex relative">
                { <div className="absolute md:relative inset-0"><MainColumn viewReport={viewReport} setViewReport={setViewReport} setAddBill={setAddBill}/> </div>}
